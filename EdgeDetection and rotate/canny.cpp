...
/*((abs(new_image->imageData[buffer + j] - new_image->imageData[buffer + 3 + j]) >= threshold)||abs((new_image->imageData[buffer + j + 1] - new_image->imageData[buffer + 3 + j + 1]) >= threshold)||abs((new_image->imageData[buffer + j + 2] - new_image->imageData[buffer + 3 + j + 2]) >= threshold)))跟右邊比*/
/*((abs(new_image->imageData[buffer + j] - new_image->imageData[buffer - 3 + j]) >= threshold)|| abs((new_image->imageData[buffer + j + 1] - new_image->imageData[buffer - 3 + j + 1]) >= threshold||abs((new_image->imageData[buffer + j + 2] - new_image->imageData[buffer - 3 + j + 2]) >= threshold)))跟左邊比*/
